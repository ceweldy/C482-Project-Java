...
public class ModifyProducts implements Initializable {
    ...
    // Parts in the Product and index of Product
    private Products product = Inventory.getAllProducts().get(productIndex);
    private ObservableList<Parts> partsInProduct = FXCollections.observableArrayList();
    private static int productIndex = MainScreen.getProductsIndex();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle){
        ...
        partsInProduct = product.getAssociatedParts();

        productID.setText("Generated ID: " + product.getID());
