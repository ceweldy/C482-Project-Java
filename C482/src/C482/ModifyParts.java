...
public class ModifyParts implements Initializable {
    ...
    // inHouse Part boolean
    private boolean inHouse;

    // Index of Part
    private static int partsIndex = MainScreen.getPartsIndex();
        ...
        try{
            ...
            if(error != null){
                ...
                if(inHouse){
                    ...
                    Inventory.updatePart(partsIndex, part);
                }
                else{
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Parts part = Inventory.getAllParts().get(partsIndex);

        partID.setText("Generated ID: " + part.getID());
        ...
        if(part instanceof Outsourced){
            ...
            partSource.setText(((Outsourced) Inventory.getAllParts().get(partsIndex)).getCompanyName());
            partOutsource.setSelected(true);
        }
        else{
            sourceLabel.setText("Machine ID");
            partSource.setText(Integer.toString(((InHouse) Inventory.getAllParts().get(partsIndex)).getMachineId()));
